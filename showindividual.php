...
<div class="container">
    ...
    <div class="header-container">
        <div class="logo-container"><img class="logo-image" src="images/foodlogo.jpeg"
                                         alt="logo: image of folk and spoon in a heart"></div>
        <div class="header">
            <h1>One Item</h1>
    ...
    <div class="body-container">
        <div class="image-container"><img class="image-of-food" alt="a picture of <?php echo $currentFood; ?>"
                                          src="<?php echo $currentImage; ?>"></div>
...
<!--                <a href="showindividual.php?next-button=Next" >NEXT</a>-->
                <form action="showindividual.php" method="get"><input type="submit" id="previous-button"
                                                                      name="previous-button" value="Previous"></form>
            </div>
            <div class="db-id-number"><?php echo "ID:  $currentId"; ?></div>
            <div class="next-button">
                <form action="showindividual.php" method="get"><input type="submit" id="next-button" name="next-button"
                                                                      value="Next"></form>
            </div>
        </div>
    </div>
